...
#you can path here.
mode = 'train' # train or test                                     
labels_path = 'your_path'+mode+'_label/_annotations.txt'            
image_path = '/your_path/'+mode                                     
new_file_path ='/your_path/'+mode+'_label/'+mode+'_info.csv'        
new_name_file = 'your_new_image_name'  
